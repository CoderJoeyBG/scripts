...
local library = {
    version = "2.0.2",
    title = title or "XDHub " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local XDHubLogo = Instance.new("ImageLabel")
    local hashLogo = Instance.new("ImageLabel")
    local XDHub = Instance.new("TextLabel")
    ...
    XDHubLogo.Name = "XDHubLogo"
    XDHubLogo.Parent = background
    XDHubLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    XDHubLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    XDHubLogo.BackgroundTransparency = 1.000
    XDHubLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    XDHubLogo.Size = UDim2.new(0, 448, 0, 150)
    XDHubLogo.Visible = true
    XDHubLogo.Image = "http://www.roblox.com/asset/?id=9365068051"
    XDHubLogo.ImageColor3 = Color3.fromRGB(159, 115, 255)
    XDHubLogo.ImageTransparency = 1
    ...
    XDHub.Name = "XDHub"
    XDHub.Parent = background
    XDHub.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    XDHub.BackgroundTransparency = 1.000
    XDHub.Size = UDim2.new(0, 80, 0, 21)
    XDHub.Font = Enum.Font.Code
    XDHub.Text = "powered by XDHub"
    XDHub.TextColor3 = Color3.fromRGB(124, 124, 124)
    XDHub.TextSize = 10.000
    XDHub.TextTransparency = 1
    ...
    CreateTween("XDHubRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(XDHubLogo, TweenTable["XDHubRotation"], {Rotation = XDHubLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(XDHub, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(XDHubLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(XDHubLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(XDHub, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
